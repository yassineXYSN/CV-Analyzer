        ...
        try:
            ...
            for app in applications:
                ...
                if candidate:
                    ...
                    from models import JobQuizAssignment, QuizAttempt
                    ...
                    if quiz_assignment:
                        # Try to get final score if available
                        score = None
                        if quiz_assignment.quiz_attempt_id:
                            attempt = db.query(QuizAttempt).filter(QuizAttempt.id == quiz_assignment.quiz_attempt_id).first()
